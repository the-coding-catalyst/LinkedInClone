...
const { followUser, unfollowUser, unlikeBlog, commentOnBlog, postsByCurrentUser, userInfo } = require('../controllers/features-controller')
...
featuresRouter.get("/user", userInfo)
featuresRouter.post("/posts", createABlog)
